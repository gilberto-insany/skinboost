export function makePreview(mode) {
  return {
    parameters: {
      ...
      skinboostMode: mode,
      docs: { description: { component: mode === 'hifi'
    ...
    decorators: [(Story) => {
      ...
      label.textContent = mode === 'hifi' ? 'Alta fidelidade · proposta em revisão' : 'Wireframe · identidade implementada';
      const note = document.createElement('span');
      note.textContent = mode === 'hifi'
