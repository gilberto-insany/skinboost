...
function renderReview(theme) {
  ...
  root.innerHTML = `<h1>Tokens Figma · ${theme === "light" ? "Light" : "Dark"}</h1>
    <p>Os 130 aliases Light/Dark foram confirmados por nome nos prints do Figma enviados pelo usuário. Fundamentos, landing e chat já consomem estes papéis funcionais. As cores hexadecimais vêm do JSON exportado; os IDs nativos não foram consultados.</p>
